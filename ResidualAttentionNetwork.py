...
class ResidualAttentionNetwork():
    ...
    def build_model(self):
        ...
        fully_connected_layer_1 = Dense(128, activation='relu')(flatten_op)
        dropout_layer_1 = Dropout(0.5)(fully_connected_layer_1)
        fully_connected_layer_2 = Dense(64, activation='relu')(dropout_layer_1)
        dropout_layer_2 = Dropout(0.5)(fully_connected_layer_2)
        fully_connected_layer_3 = Dense(32, activation='relu')(dropout_layer_2)
